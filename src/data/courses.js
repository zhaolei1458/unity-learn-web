...
export const courses = [
  {
    ...
    lessons: [
      ...
      { id: 'basics-2', title: '认识 GameObject', type: 'interactive' },
      { id: 'basics-3', title: '认识 Transform', type: 'interactive' },
      { id: 'basics-4', title: '认识相机', type: 'interactive' },
      { id: 'basics-5', title: '世界坐标 vs 本地坐标', type: 'interactive' },
      { id: 'basics-6', title: '场景 Scene', type: 'interactive' },
      { id: 'basics-7', title: '层级 Hierarchy 与父子关系', type: 'interactive' },
      { id: 'basics-8', title: '资源面板 Assets 与资源导入', type: 'interactive' },
      { id: 'basics-9', title: '编辑器快捷键与工作流', type: 'interactive' },
      { id: 'basics-10', title: '动手练：搭出你的第一个小场景', type: 'interactive' },
      { id: 'basics-11', title: '检查器 Inspector 深入', type: 'interactive' },
      { id: 'basics-12', title: '预制体 Prefab 深入', type: 'interactive' },
      { id: 'basics-13', title: '空物体与场景组织', type: 'interactive' },
      { id: 'basics-14', title: '场景视图操作进阶', type: 'interactive' },
    ],
  },
  {
    id: 'math',
  ...
  },
  {
    ...
    lessons: [
      { id: 'motion-1', title: '组件与生命周期', type: 'interactive' },
      { id: 'motion-2', title: '物理与碰撞', type: 'interactive' },
      { id: 'motion-3', title: '输入控制', type: 'interactive' },
      { id: 'motion-4', title: '动画', type: 'interactive' },
      { id: 'motion-5', title: '粒子效果', type: 'interactive' },
      { id: 'motion-6', title: 'C# 脚本基础', type: 'interactive' },
      { id: 'motion-7', title: '碰撞器 vs 触发器', type: 'interactive' },
    ],
  },
  {
    id: 'logic',
    ...
    desc: '规则、通信、调试思路',
    lessons: [
      { id: 'logic-1', title: '游戏逻辑基础', type: 'interactive' },
      { id: 'logic-2', title: '对象间通信', type: 'interactive' },
      { id: 'logic-3', title: '调试思路', type: 'interactive' },
    ],
  },
  {
    id: 'art',
    ...
    desc: '光照、UI、音效',
    lessons: [
      { id: 'art-1', title: '光照', type: 'interactive' },
      { id: 'art-2', title: 'UI 与锚点', type: 'interactive' },
      { id: 'art-3', title: '音效', type: 'interactive' },
      { id: 'art-4', title: '预制体 Prefab', type: 'interactive' },
      { id: 'art-5', title: '材质 Material', type: 'interactive' },
    ],
  },
  {
    id: 'modeling',
